...
@Component({
  ...
  templateUrl: './btc-short.component.html',
  styleUrl: './btc-short.component.css'
})
export class BtcShortComponent implements OnInit, OnDestroy {
